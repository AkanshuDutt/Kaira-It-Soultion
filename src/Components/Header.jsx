    ...
    <header className="fixed top-0 w-full backdrop-blur-3xl shadow-md z-50">
      <div className="container mx-auto flex items-center justify-between ">
        ...
        <nav className="hidden lg:flex space-x-6 relative">
          ...
          >
            <Link to="AboutPage" className="nav-link cursor-pointer "> About us</Link>
            <AnimatePresence>
              {aboutDropdownOpen && (
                <motion.div
                ...
                `  <div
                  ...
                  >
                    <Link to="/" className="dropdown-link cursor-pointer">Our Vision</Link>
                    <AnimatePresence>
                      {companyDropdownOpen && (
                        <motion.div
                          initial={{ opacity: 0, y: -10 }}
                  ...
                  <Link to="#blog" className="dropdown-link">Our Blog</Link>
          ...
          <div
            className="relative"
          >
            <span className="nav-link cursor-pointer" onClick={() => setShowNavbarItem(!ShowNavbarItem)} ref={profileDropdownRef}>  Our Services</span>
            <AnimatePresence>`
              {ShowNavbarItem && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
            ...
            <div className="flex flex-col space-y-3 px-6">
              ...
              <AnimatePresence>
                {aboutOpen && (
                  ...
                  >
                    <Link to="our-vision" className="mobile-link border-b-1 border-gray-500 inline-block w-fit" onClick={() => setMobileMenuOpen(false)}>Our Vision</Link>
